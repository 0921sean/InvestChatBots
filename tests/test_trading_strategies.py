...
def test_meanrev_entry_below_lower_band():
    closes = [100.0] * 36 + [100, 100, 100, 82]    # 막판 급락 → 하단밴드 이탈
...
def test_meanrev_exit_on_revert_to_mid():
    assert ts.meanrev_exit(_revert_series()) is True
