...
> updated: 2026-08-31 (#156·#157 머지 완료 · 8/28 인스타 유입 버스트 분석 · 정기 체크포인트 규칙 신설)
>
> **이 파일 구조 (읽는 순서):**
...
- **실매매 신뢰성 로드맵**(P1 외부 워치독 → P2 브로커 페이퍼 API → P3 90일 포워드 통과 시 소액 실계좌, +인증 2FA)은 히스토리의 `🗺️ 다음 후보` 참조 — 아직 유효.
